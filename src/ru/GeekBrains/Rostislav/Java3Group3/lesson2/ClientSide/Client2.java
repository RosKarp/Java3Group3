...
public class Client2 extends JFrame {
    ...
    private final String pathHistory2 = "C:\\Users\\Ростислав\\IdeaProjects\\GB\\src\\ru\\GeekBrains\\Rostislav\\Java3Group3\\lesson2\\ClientSide\\history_login2.txt";
    private File history2 = null;
    ...
    public Client2() {
        ...
        myMessage.setPreferredSize(new Dimension(Client2.WIDTH, 50));
        ...
        try {
            ...
            history2 = new File(pathHistory2); // создаем файл записи истории чата при условии, что он еще не создан
        }
        String s = "";
        try {
            writer = new BufferedWriter(new FileWriter(history2, true));
            reader = new BufferedReader(new FileReader(history2));
            int count = countLines(history2);           // подсчет числа строк в файле
